...
export default function Toolbar({
  ...
  const tools = [
    ...
    { id: 'BRS', name: 'Brush', label: 'Brush Tool (BRS)', icon: PaintbrushIcon, desc: 'Vector brush with styles (Solid, Calligraphy, Pencil, Marker, Airbrush, Glow)' },
    { id: 'PTS', name: 'Points Tool', label: 'Points Tool (PTS)', icon: CircleDotIcon, desc: 'Click to place connected points to create drawings and shapes' },
...
function CircleDotIcon(props: any) { return <CircleDot {...props} /> }
